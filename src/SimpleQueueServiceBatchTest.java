 ...
 */
public class SimpleQueueServiceBatchTest {

    private static final int TOTAL_MESSAGES_NUM = 1000;
    private static final int MAX_NUM_BATCH_MESSAGES = 5;
    private static final long POLLING_INTERVAL = 5 * 1000; // milliseconds
    ...
    public static void main(String[] args) throws Exception {
        ...
        AmazonSQS sqs = new AmazonSQSClient(new PropertiesCredentials(
                SimpleQueueServiceBatchTest.class.getResourceAsStream("AwsCredentials.properties")));
        ...
        try {
            ...
            for (int i = 0; i < TOTAL_MESSAGES_NUM;) {
                entries.clear();
                while (entries.size() < MAX_NUM_BATCH_MESSAGES && i < TOTAL_MESSAGES_NUM) {
                    entries.add(new SendMessageBatchRequestEntry(Integer.toString(i),
            ...
            System.out.println(String.format("It took %.2f seconds to send %d messages  by batch of  %d ",
   ...
   /*         System.out.println("Receiving messages from MyQueue.\n");
            ...
            while (totalNumOfMessagesReceived < TOTAL_MESSAGES_NUM) {
                ...
                for (Message message : messages) {
                    ...
                    sqs.deleteMessage(new DeleteMessageRequest(myQueueUrl, message
                            .getReceiptHandle()));
                }
            }
